...
export const translations: Record<string, QuestionTranslation> = {
  ...
  'rest-status-401-vs-403': {
    ...
    hint: 'Separa la autenticación de la autorización y recuerda qué falla reporta cada uno de estos códigos.',
  },
  ...
  'rest-if-match-412-lost-update': {
    ...
    hint: 'Trata `If-Match` como una escritura condicional, como el bloqueo optimista con una columna de versión, y recuerda qué debe hacer el servidor cuando la versión ya no coincide.',
  },
  ...
  'rest-idempotency-key-replay': {
    ...
    hint: 'Pregúntate qué debe pasar antes del cobro cuando una clave llega de nuevo, y qué necesita la entrada guardada para detectar una clave reutilizada con otro monto.',
  },
};
