...
export const questions: Question[] = [
  ...
  },
  {
    ...
    rubric: [
      ...
      'Layers limits: edge (WAF rate-based rules, API Gateway throttling) plus application-level',
