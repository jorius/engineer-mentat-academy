...
export const translations: Record<string, QuestionTranslation> = {
  ...
  'redux-memoized-selector': {
    ...
    hint: 'Guarda los últimos resultados de entrada y la última salida en un closure, y compara las entradas nuevas con `===` antes de volver a ejecutar el combiner.',
  },
  'redux-toolkit-immer-reassign': {
    ...
    hint: 'Immer detecta dos cosas: las mutaciones del draft y un valor devuelto. Revisa qué hace cada case reducer con el draft.',
  },
