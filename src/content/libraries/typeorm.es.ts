...
export const translations: Record<string, QuestionTranslation> = {
  'typeorm-n-plus-one-count': {
    ...
    hint: 'Recuerda qué hace a nivel de SQL cada llamada al repositorio con `await`, y si TypeORM combina alguna vez llamadas separadas.',
  },
  'typeorm-batch-posts-by-author': {
    ...
    hint: 'Piensa en qué operador de TypeORM trae filas para muchas claves en una sola consulta, y en cómo volver a alinear las filas con el contrato de DataLoader.',
  },
  'typeorm-lazy-relation-n-plus-one': {
    ...
    hint: 'Recuerda cómo implementa TypeORM una relación lazy y cuándo va a la base de datos por ella.',
  },
  'typeorm-leftjoin-vs-leftjoinandselect': {
    ...
    hint: 'Recuerda cómo decide el query builder qué relaciones hidratar en las entidades que devuelve `getMany`.',
  },
