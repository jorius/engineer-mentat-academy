...
export const questions: Question[] = [
  {
    ...
    hint:
      'Recall the meta-annotations declared on `@SpringBootApplication`, and what each one enables.',
  },
  {
    ...
    hint:
      'Recall where Spring Data repository implementations come from, and when they are created.',
  },
  {
    ...
    hint:
      'Recall how Spring can complete a field-injection cycle with early references, and what changed about circular references between Boot 2.5 and 3.x.',
  },
  {
  ...
  },
  {
    ...
    hint:
      "Recall how Spring Data's default `save` implementation chooses between `persist` and `merge`.",
  },
  {
