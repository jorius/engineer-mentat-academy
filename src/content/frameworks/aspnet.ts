...
export const questions: Question[] = [
  ...
  },
  {
    ...
    hint:
      'Trace a `GET /hello` request through the pipeline in registration order, keeping in mind the pieces the minimal hosting model adds for you.',
  },
  {
    ...
    hint:
      'Recall the order in which minimal APIs infer a binding source for a parameter that has no attribute.',
  },
  {
    ...
    hint:
      'For each client, work out how far the request gets through authentication and authorization, and what each stage returns when it fails.',
  },
  {
    ...
    hint:
      'Walk the pipeline in order: who populates `HttpContext.User`, what the minimal hosting model adds implicitly, and where each exception-handling mechanism sits.',
  },
  {
