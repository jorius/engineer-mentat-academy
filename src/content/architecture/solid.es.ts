...
export const translations: Record<string, QuestionTranslation> = {
  'solid-srp-reason-to-change': {
    ...
    hint: 'Piensa en quién pide cambios al código, no en cuántos métodos, líneas o clases tiene.',
  },
  'solid-srp-invoice-reasons': {
    ...
    hint: 'Pregúntate qué stakeholder o tecnología obligaría a editar la clase en sí, y si cada punto cambia la clase en absoluto.',
  },
  'solid-ocp-exporter-registry': {
    ...
    hint: 'Abierto-cerrado significa agregar un formato sin editar código que funciona. Cuenta cuántos lugares te obliga a tocar cada opción.',
  },
  ...
  'solid-lsp-model-capabilities': {
    ...
    hint: 'Saca `fly()` de la clase base hacia una clase intermedia para los que vuelan, y filtra las aves según tengan el método en vez de por su clase.',
  },
  ...
  'solid-dip-injectable-gateway': {
    ...
    hint: 'Pasa el gateway por el constructor, con un parámetro por defecto para que el punto de llamada de producción no cambie.',
  },
