...
export const translations: Record<string, QuestionTranslation> = {
  ...
  'cicd-blue-green-vs-canary': {
    ...
    options: {
      ...
      c: 'Rolling update: las instancias se reemplazan lote por lote, lo que da la misma comparación de métricas por porcentaje que un canary',
      d: 'Recreate: detener v1 e iniciar v2 para que solo una versión atienda tráfico, que es la forma más segura de comparar métricas limpiamente',
    },
    explanation:
