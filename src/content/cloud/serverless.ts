...
export const questions: Question[] = [
  {
    ...
    hint:
      'There are still servers somewhere; focus on who manages capacity, how it scales and how you are billed.',
  },
  {
...
console.log(envB({ userId: 7, name: 'Ana Maria' }));`,
  ...
  },
  {
    ...
    hint:
      'Recall the two components of a Lambda bill, and compare them with capacity you could run near full utilization when traffic never dips.',
  },
  {
  ...
  },
  {
    ...
    hint:
      'Estimate the switching cost of each layer of a serverless app, from the handler code to everything wired around it, and which couplings are worth insuring against.',
  },
];
