...
export const translations: Record<string, QuestionTranslation> = {
  ...
  'operations-logging-alert-fatigue': {
    ...
    options: {
      ...
      b: 'Exigir que cada alerta que hace page sea accionable y esté vinculada a un runbook; revisar los pages del último mes y eliminar o bajar de nivel las alertas que, al revisarlas, no requerían ninguna acción',
