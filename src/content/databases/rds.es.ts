...
export const translations: Record<string, QuestionTranslation> = {
  ...
  'rds-failover-behavior': {
    prompt: 'Falla el primario Multi-AZ de tu RDS for MySQL. ¿Qué afirmaciones sobre el failover son verdaderas? Selecciona todas las que apliquen.',
    options: {
