...
a Show answer fallback that reveals the key without grading once you're done trying. Hint
(or `H`) shows a short nudge toward the concept to think about, without costing an attempt. The
